...
export default function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      <Link to="/"><img className="w-36" src={assets.logo} /></Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative group">
          ...
          {
            token && 
            <div className="absolute right-0 hidden group-hover:block pt-4 z-10">
              <div className="flex flex-col gap-2 w-36 px-5 bg-slate-100 text-gray-500 rounded shadow-md">
